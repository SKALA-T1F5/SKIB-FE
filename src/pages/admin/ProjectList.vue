...
.person-icon {
    ...
    margin-right: 10px;
    /* Space between icon and user info */
}
...
.app-footer {
    text-align: center;
    padding-top: 10px;
    /* 사용자 지정 padding-top 유지 */
    padding-bottom: 10px;
    /* 하단에도 padding 추가 (선택 사항) */
    font-size: 0.9em;
    color: #aaa;
