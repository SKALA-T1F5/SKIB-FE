    ...
    <div v-if="isVisible" class="modal-overlay" @click.self="emit('close')">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- <div v-if="!hideInviteLink" class="input-group">
        ...
        <div class="modal-footer">
          <button v-if="!hideInviteLink" class="modal-button primary" @click="handleAddTest">응시</button>
          <button v-else class="modal-button primary" @click="handleLangOnly">언어 선택</button>
        </div>
      </div>
    </div>
  </teleport>
...
const emit = defineEmits(['close', 'addTest', 'langSelected', 'lang-selected']) // lang-selected 이벤트 추가
