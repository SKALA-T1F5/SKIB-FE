...
.question-list-scrollable {
  /* max-height를 calc()로 지정하여 남은 공간을 채우고, 넘치면 스크롤바가 생기도록 합니다. */
  /* 부모 요소인 v-card-text의 pa-8 (64px)과 section-title, mb-6을 고려하여 조정합니다. */
  max-height: calc(
    100vh - 180px - 64px - 32px - 24px
  ); /* 대략적인 계산. 실제 레이아웃에 따라 조정 필요 */
  overflow-y: auto;
